...
for experiment in experiment_nums:
    ...
    for direction in directions:
        ...
        #not that strainstep is dummy variable (refactor this &^%$#@!!)
        ThisConf = CF.Configuration(foldername,'experiment_square',mu,0)
        NextConf = CF.Configuration(foldername,'experiment_square',mu,0)
        ...
        for u in range(nsteps-1):
            ...
            ThisConf.ReadExpdataNextSquare(numlabel2)
            ThisConf.AddNextBoundaryContactsSquare()
